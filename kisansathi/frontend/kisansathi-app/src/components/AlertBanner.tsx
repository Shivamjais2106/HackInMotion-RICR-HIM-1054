      ...
      {visibleAlerts.map((alert) => (
        ...
        >
          ...
          <div className="flex-shrink-0 mt-1">
            {alert.type === "critical" && <Zap className="w-6 h-6 text-red-600 animate-pulse" />}
            {alert.type === "warning" && <AlertTriangle className="w-6 h-6 text-yellow-600" />}
            {alert.type === "info" && <Bell className="w-6 h-6 text-blue-600" />}
          </div>
