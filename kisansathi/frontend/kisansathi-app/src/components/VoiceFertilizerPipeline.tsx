    ...
    <div className="min-h-screen bg-eco-cream py-20">
      <div className="max-w-4xl mx-auto px-6">
        <h1 className="text-4xl font-bold text-eco-green-dark mb-2">
          🎤 Voice Fertilizer Assistant
        </h1>
        <p className="text-gray-600 mb-8">
          Speak your crop details and get fertilizer recommendations with AI-powered explanations
        </p>
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 p-6 rounded-lg border-2 border-blue-300">
                ...
                <p className="text-blue-600 mb-4">
                  Speak about your crop and soil conditions. Example: "I have rice crop with
                  nitrogen 80, phosphorus 45, potassium 60, temperature 25 degrees, humidity 70
                  percent, loamy soil"
                </p>
              </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    {state.extractedData.nitrogen && (
                      <div>
                        ...
                        <p className="text-lg font-semibold text-gray-800">
                          {state.extractedData.nitrogen} mg/kg
                        </p>
                      </div>
                    )}
                    {state.extractedData.phosphorus && (
                      <div>
                        ...
                        <p className="text-lg font-semibold text-gray-800">
                          {state.extractedData.phosphorus} mg/kg
                        </p>
                      </div>
                    )}
                    {state.extractedData.potassium && (
                      <div>
                        ...
                        <p className="text-lg font-semibold text-gray-800">
                          {state.extractedData.potassium} mg/kg
                        </p>
                      </div>
                    )}
                    {state.extractedData.temperature && (
                      <div>
                        ...
                        <p className="text-lg font-semibold text-gray-800">
                          {state.extractedData.temperature}°C
                        </p>
                      </div>
                    )}
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-eco-green">
                      {state.recommendation.recommendation.recommended_fertilizer}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Confidence</p>
                    <p className="text-lg font-semibold text-gray-800">
                      {state.recommendation.recommendation.confidence}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Application Rate (per hectare)</p>
                    <p className="text-gray-700">
                      N: {state.recommendation.recommendation.application_rate.nitrogen} kg
                      <br />
                      P: {state.recommendation.recommendation.application_rate.phosphorus} kg
                      <br />
