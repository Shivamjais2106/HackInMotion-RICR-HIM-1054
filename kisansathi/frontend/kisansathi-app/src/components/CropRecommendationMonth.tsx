          ...
          <div className="mt-8 bg-white rounded-lg shadow-lg p-8">
            {result.error ? (
              ...
              <div>
                ...
                {result.month_info && (
                  <div
                    className={`rounded-lg p-6 mb-6 ${result.month_info.suitable ? "bg-green-50 border-2 border-green-300" : "bg-yellow-50 border-2 border-yellow-300"}`}
                  >
                    ...
                    {result.month_info.alternatives &&
                      result.month_info.alternatives.length > 0 && (
                        <div className="bg-white rounded p-3">
                          <p className="text-sm font-semibold text-gray-700 mb-2">
                            {result.month_info.suitable
                          ...
                          <div className="flex flex-wrap gap-2">
                            {result.month_info.alternatives.map((crop, idx) => (
                              <span
                                key={idx}
                                className="bg-eco-green text-white px-3 py-1 rounded-full text-sm"
                              >
                                {crop}
                              </span>
                            ))}
