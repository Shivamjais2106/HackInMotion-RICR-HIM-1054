...
const chipsRow2En = ["Livestock health", "Soil analysis", "Market prices"];
...
const chipsRow2Hi = ["पशु स्वास्थ्य", "मिट्टी विश्लेषण", "बाजार भाव"];
...
const ChatbotUI = () => {
  ...
  return (
    ...
    >
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-0 z-20 flex h-screen w-14 flex-col items-center justify-between py-4 border-r transition-all ${
          messages.length > 0
      ...
      {/* Main */}
      <main
        className={`relative z-10 ml-14 flex min-h-screen flex-col transition-all ${
          messages.length > 0
