    ...
    <div className="p-8 bg-gray-900 text-white min-h-screen font-mono">
      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="bg-black p-4 rounded h-96 overflow-y-auto border border-blue-500">
            <pre className="text-blue-400 text-sm">{JSON.stringify(data, null, 2)}</pre>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 p-4 bg-gray-800 rounded">
        ...
        <div className="space-y-2">
          <p>
            Backend: <span className="text-green-400">http://localhost:5000</span>
          </p>
          <p>
            Frontend: <span className="text-green-400">http://localhost:8080</span>
          </p>
          <p>
            Total Logs: <span className="text-yellow-400">{logs.length}</span>
          </p>
        </div>
      </div>
    </div>
