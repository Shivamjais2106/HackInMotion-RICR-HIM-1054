...
class MLDiseaseDetector:
    ...
    def predict(self, image_file):
        ...
        try:
            ...
            if features is None:
                return {"success": False, "error": "Failed to extract features from image"}
    ...
    def get_management_recommendations(self, disease_name):
        ...
        recommendations = {
            ...
            "Rose   healthy": {
                ...
                "management": ["Continue regular monitoring", "Maintain proper pruning", "Ensure good air circulation"],
            },
            "Rose   rust": {
