...
<<<<<<< HEAD
        ...
        features["rainfall_intensity_encoded"] = self.feature_encoders["rainfall_intensity"].transform([rainfall_int])[
            0
        ]
...
<<<<<<< HEAD
        ...
        for idx, (crop, prob) in enumerate(zip(classes, probabilities)):
            ranking_data.append({"crop": crop, "confidence": prob * 100, "probability": prob})
...
def get_crop_recommendation(N, P, K, temperature, humidity, ph, rainfall, top_n=5):
    ...
    try:
        ...
        recommendations = recommender.get_top_crops(
<<<<<<< HEAD
            N=N, P=P, K=K, temperature=temperature, humidity=humidity, ph=ph, rainfall=rainfall, top_n=top_n
=======
            N=N, P=P, K=K,
            temperature=temperature,
            humidity=humidity,
