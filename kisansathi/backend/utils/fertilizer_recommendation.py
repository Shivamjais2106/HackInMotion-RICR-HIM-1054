...
def get_fertilizer_recommendation(
    nitrogen, phosphorus, potassium, temperature, humidity, moisture, soil_type, crop_type
):
...
def get_application_rate(crop_type, n, p, k):
    ...
    rates = {
        "rice": {"nitrogen": 120, "phosphorus": 60, "potassium": 40, "unit": "kg/hectare"},
        "wheat": {"nitrogen": 100, "phosphorus": 50, "potassium": 30, "unit": "kg/hectare"},
        "maize": {"nitrogen": 150, "phosphorus": 75, "potassium": 50, "unit": "kg/hectare"},
        "cotton": {"nitrogen": 100, "phosphorus": 50, "potassium": 50, "unit": "kg/hectare"},
        "sugarcane": {"nitrogen": 150, "phosphorus": 75, "potassium": 75, "unit": "kg/hectare"},
        "vegetables": {"nitrogen": 80, "phosphorus": 60, "potassium": 60, "unit": "kg/hectare"},
    }

    return rates.get(crop_type.lower(), {"nitrogen": 100, "phosphorus": 50, "potassium": 40, "unit": "kg/hectare"})
...
def get_application_timing(crop_type):
    ...
    timing = {
        "rice": ["Basal: 50% at planting", "Top dressing: 25% at tillering", "Top dressing: 25% at panicle initiation"],
        "wheat": ["Basal: 50% at sowing", "Top dressing: 50% at tillering"],
        "maize": ["Basal: 50% at planting", "Top dressing: 50% at 6-8 leaf stage"],
        "cotton": ["Basal: 50% at planting", "Top dressing: 25% at flowering", "Top dressing: 25% at boll formation"],
        "sugarcane": ["Basal: 100% at planting"],
        "vegetables": ["Basal: 50% at planting", "Top dressing: 50% at 30-40 days"],
    }

    return timing.get(crop_type.lower(), ["Basal: 50% at planting", "Top dressing: 50% at growth stage"])
