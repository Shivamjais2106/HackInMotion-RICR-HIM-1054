...
def analyze_soil(temperature, humidity, moisture, soil_type, nitrogen, potassium, phosphorous):
    ...
    try:
        if not all([crop_model, fertilizer_model, label_encoders, scaler]):
            ...
            return {"success": False, "error": "Models not loaded", "crop": "Unknown", "fertilizer": "Unknown"}
        ...
        top_crops = [
            {"name": label_encoders["Crop Type"].inverse_transform([idx])[0], "confidence": float(crop_proba[idx])}
        ...
        result = {
            ...
            "crop_recommendation": {"primary": crop, "confidence": crop_confidence, "top_3": top_crops},
        ...
        return {"success": False, "error": str(e), "crop": "Unknown", "fertilizer": "Unknown"}
