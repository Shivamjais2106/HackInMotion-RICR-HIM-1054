...
def identify_pest(pest_name):
    ...
    pests = {
        "Stem Borer": {
            ...
            "symptoms": ["Holes in stems", "Wilting of shoots", "Dead hearts in rice", "Yellowing of leaves"],
            "damage_level": "High",
            "management": get_pest_management("Stem Borer"),
        },
        "Leaf Folder": {
            "affected_crops": ["Rice"],
            "symptoms": ["Folded leaves", "Transparent patches", "Skeletonized leaves", "Reduced photosynthesis"],
            "damage_level": "Medium",
            "management": get_pest_management("Leaf Folder"),
        },
        "Armyworm": {
            "affected_crops": ["Maize", "Wheat", "Cotton"],
            "symptoms": ["Irregular holes in leaves", "Defoliation", "Damage to ear/cob", "Frass on leaves"],
            "damage_level": "High",
            "management": get_pest_management("Armyworm"),
        },
        "Bollworm": {
            "affected_crops": ["Cotton"],
            "symptoms": ["Holes in bolls", "Damaged seeds", "Rotting bolls", "Larva inside bolls"],
            "damage_level": "Very High",
            "management": get_pest_management("Bollworm"),
        },
        "Jassid": {
            "affected_crops": ["Cotton"],
            "symptoms": ["Yellowing of leaves", "Curling of leaves", "Stunted growth", "Sticky honeydew"],
            "damage_level": "High",
            "management": get_pest_management("Jassid"),
        },
        "Whitefly": {
            "affected_crops": ["Cotton", "Vegetables"],
            "symptoms": ["Yellowing of leaves", "Wilting", "Sticky honeydew", "Sooty mold"],
            "damage_level": "High",
            "management": get_pest_management("Whitefly"),
        },
        "Aphid": {
            "affected_crops": ["Wheat", "Maize", "Vegetables"],
            "symptoms": ["Curling of leaves", "Yellowing", "Stunted growth", "Sticky honeydew"],
            "damage_level": "Medium",
            "management": get_pest_management("Aphid"),
        },
        "Termite": {
            "affected_crops": ["Wheat", "Maize", "Sugarcane"],
            "symptoms": ["Wilting of plants", "Tunnels in soil", "Damage to roots", "Sudden plant death"],
            "damage_level": "High",
            "management": get_pest_management("Termite"),
        },
        "Scale Insect": {
            "affected_crops": ["Sugarcane"],
            "symptoms": ["Brown scales on stems", "Yellowing of leaves", "Reduced growth", "Sticky honeydew"],
            "damage_level": "Medium",
            "management": get_pest_management("Scale Insect"),
        },
        "Mealybug": {
            "affected_crops": ["Sugarcane", "Cotton"],
            "symptoms": ["White cottony masses", "Yellowing of leaves", "Stunted growth", "Sticky honeydew"],
            "damage_level": "Medium",
...
def get_pest_management(pest_name):
    ...
    strategies = {
        ...
        "Leaf Folder": {
            "cultural": ["Remove affected leaves", "Maintain field sanitation", "Avoid excessive nitrogen"],
            "biological": ["Use Bacillus thuringiensis (Bt)", "Release parasitoids"],
            "chemical": ["Spray Chlorpyrifos 20 EC (1.5 L/hectare)", "Spray Monocrotophos 36 SL (1 L/hectare)"],
            "monitoring": "Check for folded leaves and transparent patches",
        },
        "Armyworm": {
            "cultural": ["Plow field after harvest", "Remove crop residues", "Avoid continuous cropping"],
            "biological": ["Use Bacillus thuringiensis (Bt)", "Release parasitoids", "Encourage natural enemies"],
            "chemical": [
                "Spray Chlorpyrifos 20 EC (1.5 L/hectare)",
        ...
        "Bollworm": {
            "cultural": ["Destroy crop residues", "Remove affected bolls", "Crop rotation", "Avoid late sowing"],
            "biological": [
                "Release Trichogramma parasitoids",
                "Use Bacillus thuringiensis (Bt)",
                "Encourage natural predators",
        ...
        "Jassid": {
            "cultural": ["Remove affected leaves", "Maintain field sanitation", "Avoid excessive nitrogen"],
            "biological": ["Release parasitoids", "Encourage natural predators"],
            "chemical": [
        ...
        "Whitefly": {
            "cultural": ["Remove affected leaves", "Use yellow sticky traps", "Maintain field sanitation"],
            "biological": ["Release parasitoids", "Use neem oil spray"],
            "chemical": [
                "Spray Imidacloprid 17.8 SL (0.5 L/hectare)",
                "Spray Thiamethoxam 25 WG (0.4 kg/hectare)",
                "Spray Spinosad 45 SC (0.5 L/hectare)",
        ...
        "Aphid": {
            "cultural": ["Remove affected leaves", "Use reflective mulches", "Maintain field sanitation"],
            "biological": ["Release ladybugs", "Use neem oil spray", "Encourage natural predators"],
            "chemical": [
                "Spray Imidacloprid 17.8 SL (0.5 L/hectare)",
                "Spray Dimethoate 30 EC (0.75 L/hectare)",
        ...
        "Termite": {
            "cultural": ["Deep plowing", "Remove crop residues", "Avoid waterlogging", "Crop rotation"],
            "biological": ["Use Beauveria bassiana", "Use Metarhizium anisopliae"],
            "chemical": [
        ...
        "Scale Insect": {
            "cultural": ["Remove affected stems", "Maintain field sanitation", "Avoid excessive nitrogen"],
            "biological": ["Release parasitoids", "Encourage natural predators"],
            "chemical": [
                "Spray Chlorpyrifos 20 EC (1.5 L/hectare)",
                "Spray Malathion 50 EC (1 L/hectare)",
        ...
        "Mealybug": {
            "cultural": ["Remove affected parts", "Maintain field sanitation", "Avoid excessive nitrogen"],
            "biological": ["Release parasitoids", "Use neem oil spray"],
            "chemical": [
                "Spray Imidacloprid 17.8 SL (0.5 L/hectare)",
                "Spray Spinosad 45 SC (0.5 L/hectare)",
