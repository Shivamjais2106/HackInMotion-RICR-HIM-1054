...
def register_connection_events(socketio):
    ...
    def handle_connect():
        ...
        if user_id:
            ...
            emit(
                "user_online",
                {"user_id": user_id, "status": "online", "timestamp": datetime.now().isoformat()},
                broadcast=True,
            )
    ...
    def handle_disconnect():
        ...
        if request.sid in online_users:
            ...
            emit(
                "user_offline",
                {"user_id": user_id, "status": "offline", "timestamp": datetime.now().isoformat()},
                broadcast=True,
            )
...
def register_chat_events(socketio):
    ...
    def handle_join_group(data):
        ...
        emit(
            "user_joined_group",
            {"user_id": user_id, "group_id": group_id, "timestamp": datetime.now().isoformat()},
...
<<<<<<< HEAD
                ...
                db["messages"].insert_one(
                    {
                        ...
                        "sender": {"id": ObjectId(user_id), "name": data.get("user_name", "Unknown")},
                        "text": message,
                        "timestamp": datetime.now().isoformat(),
                        "reactions": [],
                    }
    ...
    def handle_stop_typing(data):
        ...
        emit("user_stopped_typing", {"user_id": user_id, "group_id": group_id}, room=f"group_{group_id}", skip_sid=True)
...
def register_notification_events(socketio):
    ...
    def handle_subscribe_notifications(data):
        ...
        emit("notification_subscribed", {"user_id": user_id, "status": "subscribed"})
